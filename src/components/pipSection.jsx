...
const PipSection = ({pips, setPips}) => {
    ...
    const [currentSliceNumber, setCurrentSliceNumber] = useState(4)
            ...
            <ul className="pipcontainer">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        {avatar.toLowerCase().includes('felix') && (
                                            ...
                                            <button onClick={() => deletePip(id)} className="delete h-fit p-0.5 border border-slate-500 cursor-pointer hover:bg-red-500 hover:text-white rounded-lg text-xs">
                ...
                <div className="flex justify-center w-full py-3">
                    ...
                    {currentSliceNumber < pips.length ? (
                        ...
                        <button onClick={() => getPips()} className="bg-black text-sm text-white w-fit rounded-lg py-1 px-2 hover:bg-slate-800 cursor-pointer">Show more</button>
                    ) : (
